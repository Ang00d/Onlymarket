...
<header id="titulo">
      ...
      <table>
           <tr>
            ...
            ?>
    <form action="proyectoADMIN.php" method="post">
            <tr>
                <td><?php echo $mostrar['ID']?></td>
                <td><input type="text" value="<?php echo $mostrar['NOMBRE'] ?>" name="nom"></td>
                <td><input type="text" value="<?php echo $mostrar['PRESIO'] ?>" name="pre"></td>
                

                    
                <td><a href="proyectoADMIN.php">ACTUALIZAR</a></td>
                </form>
            </tr>
